...
| `oc/` | opencode-go — `https://opencode.ai/zen/go/v1`; **legacy alias `ocg/` maps to the same provider** (existing tests pin `ocg/deepseek-v4-flash`) | `deepseek-v4-flash`, `mimo-v2.5` |
