...
class TestResolveEffort:
    def test_unpinned_defers_to_chat_default(self) -> None:
        assert AgentConfig(reasoning_effort="high").resolve_effort("background") == "high"
    ...
    def test_role_pin_wins(self) -> None:
        ...
        assert a.resolve_effort("subagent") == "high"  # inherits chat default
